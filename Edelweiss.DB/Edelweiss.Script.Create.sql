...
drop table NotificacaoAgenda
go

drop table ConfiguracaoNotificacaoAgenda
go

drop table UnidadeTempoAgenda
go

drop table LogSmsAgenda
go

drop table Agenda
go

drop table MedicoExecucaoAgenda
go

drop table EstadoAgenda
go
