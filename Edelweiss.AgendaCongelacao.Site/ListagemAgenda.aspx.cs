...
{
    public partial class ListagemAgenda : System.Web.UI.Page
    {
        #region Properteies
        ...
        protected void gvAgendamentos_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            this.gvAgendamentos.PageIndex = e.NewPageIndex;
            this.CarregarAgendamentos();
        }
        ...
        protected void gvAgendamentos_RowDataBound(object sender, GridViewRowEventArgs e)
        {
        ...
        protected void gvAgendamentos_Sorting(object sender, GridViewSortEventArgs e)
        {
            ...
            VsAgendas = agendas;
            this.gvAgendamentos.PageIndex = 0;
            this.gvAgendamentos.DataSource = agendas;
            this.gvAgendamentos.DataBind();
        }
